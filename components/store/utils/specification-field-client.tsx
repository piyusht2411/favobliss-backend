...
export const SpecificationFieldClient = ({
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                onClick={() =>
                  router.push(`/${params.storeId}/specification-fields/${id}`)
                }
              >
  ...
  const onDelete = async () => {
    ...
    try {
      setLoading(true);
      await axios.delete(
        `/api/${params.storeId}/specification-fields/${selectedId}`
      );
      router.refresh();
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          onClick={() =>
            router.push(`/${params.storeId}/specification-fields/create`)
          }
        >
